    ...
    <header class="nav-header">
        <div class="nav-header-div">
            <div class="nav-header-div-lt">
                <a class="text-dec-none font-bold margin-lr font-primary-color" href="#">HOME</a>
                <a class="text-dec-none font-bold margin-lr font-primary-color" href="#">FILTER</a>
                <a class="text-dec-none font-bold margin-lr font-primary-color" href="#">PRODUCTS</a>
            </div>
            <div class="nav-header-div-mid">
                <input class="input-outlined" type="text" placeholder="Search" />
            </div>
            <div class="nav-header-div-rt">   
                        <a href="#" class="btn-small margin-lr">Login</a>
                        ...
                        <div class="badge-container margin-lr">
                            <a href="#"><img src="https://img.icons8.com/ios/30/000000/add-shopping-cart--v1.png" alt="icons"/>
