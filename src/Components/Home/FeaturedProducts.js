...
function FeaturedProducts({image, itemName, itemDesc}) {
    return (    
                    <div className="card card-small gray-shadow">
                        <div className="card-upper">
                            <div className="image-vertical">
                                <img className="image-vertical-img-med" src={image} alt="stadium" />
                            </div>
                            <div className="text">
                                <div className="text-heading">
                                    <h3 className="font-bold font-xl margin-no">{itemName}</h3>
                                    <p className="font-bold margin-top-small">{itemDesc}</p>
                                </div>
                            </div>
